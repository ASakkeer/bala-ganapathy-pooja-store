...
export function HeroBanner({
  ...
  return (
    <FullBleed>
      <section className="relative isolate min-h-[28rem] overflow-hidden bg-[#3d1016] text-on-brand sm:min-h-[32rem] lg:min-h-[36rem]">
        {imageSrc ? (
          <Image
            src={imageSrc}
            alt={imageAlt}
        ...
        <Container className="relative flex min-h-[28rem] flex-col justify-end py-10 sm:min-h-[32rem] sm:py-14 lg:min-h-[36rem] lg:justify-center lg:py-20">
          <div className="max-w-2xl">
            ...
            <div className="mt-8">
              <Link href="/shop" className={buttonClassName("inverse")}>
                {copy.shopNow}
              </Link>
            </div>
          </div>
